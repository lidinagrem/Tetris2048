...
public class Tetris2048 {
   public static void main(String[] args) {
      ...
      StdDraw.setXscale(-0.5 , gridW - 0.5 + offset);
      ...
      displayGameMenu(gridH, gridW + offset);
      ...
      while (true) {
         ...
         // if the down arrow key is being pressed
            ...
            currentTetromino.rotateTetromino(grid, currentTetromino.canBeRotated(grid));
      ...
      // print a message on the console that the game is over and Restart the game if the user Presses R
      if(StdDraw.isKeyPressed(KeyEvent.VK_R)){
         restartGame(gridH, gridW);}

      Font font3 = new Font("Arial", Font.PLAIN, 30);
      StdDraw.setFont(font3);
      StdDraw.setPenColor(new Color(255, 255, 255));
      StdDraw.text(7.5, 10, "GAME OVER!");
      StdDraw.text(7.5, 8, "PRESS R TO RESTART");
      StdDraw.show();
      StdDraw.pause(20);
   ...
   // A method to restart the game
      public static void restartGame(int gridH, int gridW){
   ...
   public static Tetromino createTetromino() {
      ...
      char[] tetrominoTypes = { 'I', 'O', 'Z', 'L', 'J', 'T', 'S' };
   ...
   public static void displayGameMenu(int gridHeight, int gridWidth) {
      ...
      Color backgroundColor = new Color(45, 46, 46);
      Color buttonColor = new Color(59, 60, 61);
      Color textColor = new Color(27, 28, 28);
      // clear the background canvas to background_color
      StdDraw.clear(backgroundColor);
      // the relative path of the image file
      String imgFile = "menu_image.png";
